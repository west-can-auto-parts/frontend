...
const BlogSkeleton = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {Array.from({ length: 3 }).map((_, index) => (
            <div
                key={index}
                className="bg-white shadow-md rounded-lg h-[340px] animate-pulse flex flex-col"
            >
...
const LogoSkeletonGrid = () => (
    <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 gap-4">
        {Array.from({ length: 6 }).map((_, index) => (
            <div
                key={index}
                className="bg-white rounded-lg shadow p-4 flex flex-col items-center animate-pulse h-32"
            >
...
const LatestNews = () => {
    ...
    useEffect(() => {
        const getAllData = async () => {
            try {
                const [blogList, supplierList, vehicleList] =
                    await Promise.all([
                        fetchBlogs(),
                        fetchSuppliers(),
                        fetchVehicles(),
    ...
    const filteredVehicles = vehicles.filter(
        (vehicle) =>
            vehicle?.name &&
            vehicle.name.toUpperCase() !== "PONTIAC"
    );
    ...
    return (
        <section className="py-12">
            <div>
                ...
                <h2 className="w-10/12 mx-auto text-2xl font-bold mb-6">
                    Latest News & Blogs
                </h2>
                    ...
                    {loading ? (
                        ...
                        >
                            {blogs.map((blog) => (
                                ...
                                >
                                    <div
                                        className="bg-white shadow-md rounded-lg h-full flex flex-col cursor-pointer"
                                        onClick={() =>
                                            router.push(
                                                `/blogs/${blog.id}`
                                            )
                                    ...
                                    >
                                        ...
                                        {blog?.imageUrl ? (
                                            ...
                                            <div className="w-full h-52 bg-gray-200 rounded-t flex items-center justify-center">
                                        ...
                                        <p className="font-semibold text-sm bg-white w-fit text-[#b12b29] px-4 py-1 rounded-md mt-[-30px]">
                                            {blog?.categories?.[0] ||
                                                "General"}
                                        </p>
                                        ...
                                        <div className="p-4 flex flex-1 flex-col">
                                            ...
                                            {blog?.link && (
                                                <a
                                                    href={blog.link}
                                                    className="text-[#b12b29] hover:underline mt-auto"
                                                    onClick={(event) =>
                                                ...
                                                supplier?.imageUrl ? (
                                                    ...
                                                    >
                                                        <div
                                                            ...
                                                            style={{
                                                                backgroundImage: `url("${supplier.imageUrl}")`,
                                                            }}
                                                        />
